...
import (
	...
	"github.com/amalley/be-workshop/ch-9/api/authentication/public"
	"github.com/amalley/be-workshop/ch-9/api/database"
	"github.com/amalley/be-workshop/ch-9/api/database/scylla"
	"github.com/amalley/be-workshop/ch-9/api/handlers/consumer"
	wikiprom "github.com/amalley/be-workshop/ch-9/api/metrics/prometheus"
	"github.com/amalley/be-workshop/ch-9/api/middleware"
	"github.com/amalley/be-workshop/ch-9/api/server"
	"github.com/amalley/be-workshop/ch-9/api/stream"
	"github.com/amalley/be-workshop/ch-9/api/stream/wiki"
	wikicons "github.com/amalley/be-workshop/ch-9/api/stream/wiki/consumer"
	"github.com/amalley/be-workshop/ch-9/api/utils"
	"github.com/amalley/be-workshop/ch-9/cli"
